(()=>{
  ...
  const appendScript=(key,src,onload)=>{
    ...
    if(existing){
      if(onload){
        const ready=(key==='collaboration-v2'&&window.__collaborationSpaceV2Loaded)||(key==='collaboration-v3'&&window.__collaborationSpaceV3Loaded)||(key==='collaboration-v4'&&window.__collaborationSpaceV4Loaded)||(key==='collaboration-v5'&&window.__collaborationSpaceV5Loaded)||(key==='collaboration-v6'&&window.__collaborationSpaceV6Loaded);
        if(ready)onload();
  ...
  setTimeout(()=>appendStyle('admin-flat-blue-v1','assets/admin-flat-blue-v1.css?v=2'),0);
})();
