...
.transfer-v12-all{grid-template-columns:28px minmax(0,1fr) auto;gap:7px;padding:0 9px;margin-bottom:5px}.transfer-v12-all:hover,.transfer-v12-node-main:hover{background:#f7faff;color:#315f8d}.transfer-v12-all.active,.transfer-v12-node-main.active{background:#eaf3ff;color:#1769ff;font-weight:650}
.transfer-v12-all>.icon-stack{width:17px;height:17px}.transfer-v12-count{min-width:23px;height:20px;padding:0 6px;border-radius:6px;background:#f3f6fa;color:#8796a7;display:inline-flex;align-items:center;justify-content:center;font-size:9px;font-style:normal}.active>.transfer-v12-count{background:#fff;color:#1769ff}
