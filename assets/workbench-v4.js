...
(function(){
  ...
  function ensureAdminDeptV11(attempt=0){
    if(window.__adminDeptConsoleV11||document.getElementById('admin-dept-console-v11-script'))return;
    if(!window.__adminDeptConsoleV3){
      if(attempt<180)window.setTimeout(()=>ensureAdminDeptV11(attempt+1),50);
      return;
    }
    const script=document.createElement('script');
